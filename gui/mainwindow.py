...
class MyHealthCareBot(QMainWindow):
    ...
    def process_input(self):
        ...
        formatted_output = f"""
			...
			<hr>
			<p><b>Dr. Lili:</b><pre style="white-space: pre-wrap; font-size: 14px; font-family: Arial; line-height: 1.5;">
			{bot_output.replace(":**", '</b>:').replace("**", '<b>').replace("*", "-").replace("\n", '<br>')}
			</pre><p>
		"""
        ...
        self.tts_engine.say(bot_output)
